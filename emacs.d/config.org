...
Enable upcase region and downcase region to prevent weird disable language on first use
#+BEGIN_SRC emacs-lisp
...
#+BEGIN_SRC emacs-lisp
  (use-package helm
    ...
    :bind
    ("M-x" . helm-M-x)
    ("C-S-s" . tabfugnic/helm-do-grep-ag-project)
    ("C-x C-f" . helm-find-files)
    :init
    (helm-mode)
    ;;;###autoload
    (defun tabfugnic/helm-do-grep-ag-project (arg)
...
#+BEGIN_SRC emacs-lisp
    ...
    (use-package cargo
      ...
      (let ((cargo-bin (expand-file-name "~/.cargo/bin")))
        (setenv "PATH" (concat (getenv "PATH") path-separator cargo-bin))
...
** AI
   #+BEGIN_SRC emacs-lisp
     ...
     (use-package whisper
       :vc (:url "https://github.com/natrys/whisper.el" :branch "main")
       :bind ("C-:" . whisper-run))
...
#+BEGIN_SRC emacs-lisp
  (use-package org
   ...
   (use-package
    ...
    :vc
    (:url
     "https://github.com/tabfugnic/org-retro.git"
     :rev
     :newest
     :branch "main")
    :defer t)
